...
public class MainExercicios {
	...
	public static void main(String[] args) {
			...
			do {
					...
					System.out.println("LISTA DE LOGICA");
					System.out.print("Escolha o exercicio desejado pela numeração de 1 a 30");
					System.out.print("Para sair digite um numero maior que 30");
					opcao = input.nextInt();
